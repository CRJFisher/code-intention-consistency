...
1.  [Motivation](https://agent-trace.dev/?utm_source=substack&utm_medium=email#1-motivation)
2.  [Goals](https://agent-trace.dev/?utm_source=substack&utm_medium=email#2-goals)
3.  [Non-Goals](https://agent-trace.dev/?utm_source=substack&utm_medium=email#3-non-goals)
4.  [Terminology](https://agent-trace.dev/?utm_source=substack&utm_medium=email#4-terminology)
5.  [Architecture Overview](https://agent-trace.dev/?utm_source=substack&utm_medium=email#5-architecture-overview)
6.  [Core Specification](https://agent-trace.dev/?utm_source=substack&utm_medium=email#6-core-specification)
7.  [Extensibility](https://agent-trace.dev/?utm_source=substack&utm_medium=email#7-extensibility)
8.  [Reference Implementation](https://agent-trace.dev/?utm_source=substack&utm_medium=email#8-reference-implementation)
9.  [Appendix](https://agent-trace.dev/?utm_source=substack&utm_medium=email#appendix)
...
![Agent Trace Architecture](https://agent-trace.dev/assets/images/agent-trace-diagram-dark.png)
