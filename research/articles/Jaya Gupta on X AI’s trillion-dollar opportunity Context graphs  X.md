...
![Image](https://pbs.twimg.com/media/G83zx64XkAE-f-X?format=jpg&name=medium)



](https://x.com/JayaGup10/article/2003525933534179480/media/2003525448194560001)
...
The debate right now is whether those systems survive the shift to agents. Jamin Ball’s recent post “

” hit a nerve. Pushing back on the “agents kill everything” narrative, he argues that agents don’t replace systems of record, they raise the bar for what a good one looks like.
...
and Databricks as the “truth registry” layer. Both are leaning in – Snowflake pushing Cortex and acquiring Streamlit, Databricks acquiring Neon and launching Lakebase and AgentBricks. The pitch: data platforms replace systems of record and become the foundation for AI agents.
...
Of the many startups going after the AI SDR category,

has chosen to build an AI-native sales engagement platform to replace legacy platforms like Outreach/Salesloft, which were designed for humans executing sequences across a fragmented toolchain. Regie is designed for a mixed team where the agent is a first-class actor: it can prospect, generate outreach, run follow-ups, handle routing, and escalate to humans.
...
is doing this in finance: automating cash, close management, and core accounting workflows without ripping out the GL. The ERP remains the ledger, but Maximor becomes the source of truth where the reconciliation logic lives.
...
Published on 12.22.2025 Written by Jaya Gupta and Ashu Garg

[

![Chuck Fisher](https://pbs.twimg.com/profile_images/1251908891656544256/SPp_9HIT_x96.jpg)



](https://x.com/CRJFisher)

Post your reply

Special plug to the companies in this post:

And most forms of knowledge work will need decision traces to automate
...
2026: Sholto Douglas, Anthropic, predicts the Claude Code experience but for \*ALL\* forms of knowledge work. x.com/peterwildeford…

![](https://pbs.twimg.com/amplify_video_thumb/2004635031352778752/img/HQM9gLlwWs4O13Ks.jpg)
...
[Show more](https://x.com/akoratana/status/2006177902333714939)

great article! i had this idea of a log graph that ties to a knowledge graph that feels similar to your tracing/context graph relationship.
...
i started rebuilding babyagi a month ago as a graph based agent

[

![Image](https://pbs.twimg.com/media/GLkOKhbakAA3Nl4?format=jpg&name=medium)



](https://x.com/yoheinakajima/status/1781470930474344620/photo/1)

Oh my goodness I forgot about babyagi

Totally agree, however the ERPs know this is happening so they're all working on ways to build agentic flows across their data sets. To me the question is how traditional "workflow-protected" data systems can be reused or re-engineered to offer these agentic-driven experiences.

Yeah

Great read! Do you have a view on how Palantir’s Foundry/AIP fits into this? Seems like these decision trace artifacts and their resulting context graphs should be possible to generate and store in Foundry/AIP. And they also have the added benefit of the ontology of the

Palantir validates this thesis

great write up

Thank you

Return of GraphRAG? ![😆](https://abs-0.twimg.com/emoji/v2/svg/1f606.svg "Smiling face with open mouth and tightly-closed eyes")

no

Great article.. very accurate in pinpointing that decisions trees and context graphs are the real leverage points here.. But do you think that agents will be able to capture decision trees as cleanly as we imagine? I think as agents get involved, human behaviour will change..